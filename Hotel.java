...
class Hotel{
    ...
    static void occupied(int ch)
    {
        int j;
        switch (ch) {
            case 1:
            	System.out.println("The rooms that have been booked in Luxury Double Room are:");
                for(j=0;j<10;j++)
                {
                    if(ob.drl[j]!=null)
                ...
                break;
            case 2:
            	System.out.println("The rooms that have been booked in Deluxe Double Room are:");
                ...
                break;
            case 3:
            	System.out.println("The rooms that have been booked in Luxury Single Room are:");
                ...
                break;
            case 4:
            	System.out.println("The rooms that have been booked in Deluxe Single Room are:");
    ...
    static void deallocate(int rn, int i){
        ...
        static void cancel(int rn, int i){
            char w;
            ...
            switch (i){
                case 1: if(ob.drl[rn] != null)
                    ...
                    if(w=='y' || w == 'Y'){
                        ob.drl[rn] =null;
                        System.out.println("Your bill is zero if you already paid then money will be refunded in 2 working days!");
                        System.out.println("Room Cancelled succesfully :(");
                    }
                    break;
